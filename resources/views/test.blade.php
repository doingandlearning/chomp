  ...
  $(document).ready(function(){
    ...
    function childHTML(i) {
      return '<div id="divchild' + i +'"class="bg-grey-lighter shadow-md rounded px-8 pt-6 pb-8 mb-4">\n' +
          ...
          '          </div>\n' +
          '          <div class="mb-4">\n' +
          '          <label class="text-gray-700" for="child[' + i + '][special_requirements]">Special food requirements</label>\n' +
          '      <input class="form-input mt-1 block w-full" type="text" value="" class="form-control" id="child[' + i + '][special_requirements]" name="child[' + i + '][special_requirements]">\n' +
          '          </div>\n' +
